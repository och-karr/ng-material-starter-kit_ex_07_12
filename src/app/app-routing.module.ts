...
import {
  EmployeeListWithDeleteComponent
} from './components/employee-list-with-delete/employee-list-with-delete.component';
import {
...
import {
  EmployeeListWithDeleteComponentModule
} from './components/employee-list-with-delete/employee-list-with-delete.component-module';
...
@NgModule({
  ...
  }, {path: 'refresh-products', component: ProductListWithDeleteComponent}, {
    path: 'refresh-employees',
    component: EmployeeListWithDeleteComponent
