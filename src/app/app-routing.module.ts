...
@NgModule({
  imports: [RouterModule.forRoot([{ path: 'products/:category', component: FilteredProductListRoutingComponent }, { path: 'products', component: FilteredProductListSubjectComponent }, { path: 'sorted-products', component: SortedProductListComponent }, { path: 'sorted-employees', component: SortedEmployeeListComponent }]), FilteredProductListRoutingComponentModule, CategoryServiceModule, FilteredProductListSubjectComponentModule, ProductServiceModule, SortedProductListComponentModule, SortedEmployeeListComponentModule, EmployeeServiceModule],
